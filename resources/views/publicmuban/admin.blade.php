    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue" role="navigation">
      ...
      <!-- 导航logo -->
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><img style="display:inline" width="30px" src="/admins/img/1.png" alt="">   Laravel 冬哥后台管理系统</a>
        </div>
    ...
    <div class="row body">
      ...
      <div class="col-md-2">
        ...
        <div class="panel panel-primary">
          ...
          <ul class="list-group">
              <li class="list-group-item"><a href="/admin/user">管理员列表</a></li>
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h2 class="panel-title"><span class="glyphicon glyphicon-user"></span> 图片管理</h2>
          </div>
          <ul class="list-group">
              <li class="list-group-item"><a href="/admin/pic">图片列表</a></li>
