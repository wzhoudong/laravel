...
<div class="col-md-10">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<a href="" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 修改图片</a>
		</div>
		<div class="panel-body">
			<form action="/admin/pic/{{$data->id}}" method="post">
				...
				<div class="form-group">
					...
					<input type="hidden" name="img" id="imgs" value="{{$data->img}}">
				</div>
